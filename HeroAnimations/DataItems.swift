...
class DataModel : ObservableObject {
    @Published var items = [
        ...
        ItemData(id: 12, name: "Parrot Couple", image: "parrot-pair", author: "Roi Dimor", class: "Aves"),
        ItemData(id: 13, name: "Goldfish", image: "goldfish", author: "Hans Jurgen Mager", class: "Actinopterygii"),
        ItemData(id: 14, name: "Polar Bear", image: "polar-bear", author: "Adam Berkecz", class: "Mammal"),
        ItemData(id: 15, name: "Dolphin", image: "dolphin", author: "Gary Bendig", class: "Mammal"),
        ItemData(id: 16, name: "Raccoon", image: "raccoon", author: "Sid Balachandran", class: "Mammal"),
        ItemData(id: 17, name: "Penguin", image: "penguin", author: "Jay Ruzesky", class: "Aves"),
        ItemData(id: 18, name: "Panda Bear", image: "panda-bear", author: "Zhengtao Tang", class: "Mammal")
    ]
